 ...
 * against the archived manifest in `ggov-algoquarters/data/tinyman/`. Every account has to match.
 *
...
const ARCHIVE_DIR = join(dirname(fileURLToPath(import.meta.url)), '../../common/ggov-algoquarters', 'data', 'tinyman')
