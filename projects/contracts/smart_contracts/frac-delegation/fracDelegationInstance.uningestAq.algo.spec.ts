...
import { errAqNotStarted, errRegistryMissing, errUnauthorized } from '../base/errors.algo'
 ...
 *   4. for each account:                              // ← FIRST inner call here
 ...
 * contract in isolation. Everything in step 4+ depends on an *inner app call*
 ...
 *
 * So this file unit-tests exactly the guards in steps 1–3 — the rejections that
