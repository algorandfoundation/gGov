/**
 * Opcode costs and the group-size limit live in `sdk-shared`, which both SDKs' executors are
 * built on; re-exported here so this package's public surface is unchanged.
 */
import { MAX_GROUP_SIZE } from 'sdk-shared'
export { increaseBudgetBaseCost, increaseBudgetIncrementCost, MAX_GROUP_SIZE } from 'sdk-shared'
