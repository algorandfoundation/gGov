 ...
 * slots. Foreign/box references are capped at {@link REF_SLOTS_PER_APP_CALL} per app call, so a
 * method touching more than that needs company in the group or resource population fails with
