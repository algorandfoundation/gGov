...
export default function ConnectedWalletsEligibility({
  ...
  return (
    <details
      className={cn('group mx-auto max-w-2xl overflow-hidden rounded-xl border border-border bg-card', className)}
    >
      <summary className="flex cursor-pointer items-center justify-between gap-2 px-[18px] py-[14px] hover:bg-muted/50 [&::-webkit-details-marker]:hidden">
        <div className="flex items-center gap-2.5">
          <span
            className={cn('size-[9px] shrink-0 rounded-full', anyEligible ? 'bg-success' : 'bg-muted-foreground')}
          />
